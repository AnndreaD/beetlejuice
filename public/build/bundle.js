...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			p = element("p");
    			t0 = text("This site is under construction, check out 'Add new' and bottlespinn");
    			t1 = space();
    			h1 = element("h1");
    			t2 = text("LOLOLOLOLOL");
    			this.h();
    		...
    		l: function claim(nodes) {
    			...
    			t0 = claim_text(p_nodes, "This site is under construction, check out 'Add new' and bottlespinn");
    			p_nodes.forEach(detach_dev);
    			t1 = claim_space(main_nodes);
    			h1 = claim_element(main_nodes, "H1", {});
    			var h1_nodes = children(h1);
    			t2 = claim_text(h1_nodes, "LOLOLOLOLOL");
    		...
    		h: function hydrate() {
    			...
    			add_location(h1, file$1, 24, 4, 440);
    ...
    function create_fragment$c(ctx) {
    	...
    	function select_selectedValue_binding(value) {
    		/*select_selectedValue_binding*/ ctx[7].call(null, value);
    	}

    	let select_props = { items: /*items*/ ctx[5] };

    	if (/*selectedValue*/ ctx[4] !== void 0) {
    		select_props.selectedValue = /*selectedValue*/ ctx[4];
    	}
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			t11 = claim_text(button0_nodes, "Enter question");
    			...
    			t13 = claim_text(h21_nodes, "New Claim");
    			h21_nodes.forEach(detach_dev);
    			t14 = claim_space(div1_nodes);
    			p2 = claim_element(div1_nodes, "P", { class: true });
    			var p2_nodes = children(p2);
    			t15 = claim_text(p2_nodes, "text:");
    			...
    			t18 = claim_text(p3_nodes, "category:");
    			...
    			t21 = claim_text(button1_nodes, "Enter Claim");
    		...
    		h: function hydrate() {
    			add_location(br0, file$a, 65, 4, 1310);
    			add_location(br1, file$a, 66, 4, 1321);
    			add_location(h20, file$a, 68, 8, 1367);
    			attr_dev(p0, "class", "svelte-13rnqx2");
    			add_location(p0, file$a, 69, 8, 1397);
    			...
    			add_location(textarea0, file$a, 70, 8, 1418);
    			attr_dev(p1, "class", "svelte-13rnqx2");
    			add_location(p1, file$a, 71, 8, 1514);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "class", "categoryinput svelte-13rnqx2");
    			attr_dev(input0, "name", "fname");
    			add_location(input0, file$a, 73, 8, 1585);
    			attr_dev(button0, "class", "svelte-13rnqx2");
    			add_location(button0, file$a, 74, 8, 1680);
    			attr_dev(div0, "class", "containerbox svelte-13rnqx2");
    			add_location(div0, file$a, 67, 4, 1332);
    			add_location(h21, file$a, 78, 8, 1848);
    			attr_dev(p2, "class", "svelte-13rnqx2");
    			add_location(p2, file$a, 79, 8, 1875);
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*questionCategory*/ ctx[1]);
    			append_dev(div0, t10);
    			...
    			set_input_value(textarea1, /*claim*/ ctx[2]);
    			append_dev(div1, t17);
    			append_dev(div1, p3);
    			append_dev(p3, t18);
    			append_dev(div1, t19);
    			append_dev(div1, input1);
    			set_input_value(input1, /*claimCategory*/ ctx[3]);
    			append_dev(div1, t20);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!updating_selectedValue && dirty & /*selectedValue*/ 16) {
    				updating_selectedValue = true;
    				select_changes.selectedValue = /*selectedValue*/ ctx[4];
    				add_flush_callback(() => updating_selectedValue = false);
    			}

    			select.$set(select_changes);

    			if (dirty & /*questionCategory*/ 2 && input0.value !== /*questionCategory*/ ctx[1]) {
    				set_input_value(input0, /*questionCategory*/ ctx[1]);
    			}
    			...
    			if (dirty & /*claimCategory*/ 8 && input1.value !== /*claimCategory*/ ctx[3]) {
    				set_input_value(input1, /*claimCategory*/ ctx[3]);
    			}
    		},
    		i: function intro(local) {
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<AddNew> was created with unknown prop '${key}'`);
    	});
    	...
    	function input0_input_handler() {
    		questionCategory = this.value;
    		$$invalidate(1, questionCategory);
    	}

    	const click_handler = () => doPost(questionUrl, {
    		text: question,
    	...
    	function input1_input_handler() {
    		claimCategory = this.value;
    		$$invalidate(3, claimCategory);
    	}

    	const click_handler_1 = () => doPost(claimUrl, { text: claim, category: claimCategory });

    	$$self.$$set = $$props => {
    		if ("question" in $$props) $$invalidate(0, question = $$props.question);
    		if ("questionCategory" in $$props) $$invalidate(1, questionCategory = $$props.questionCategory);
    		if ("claim" in $$props) $$invalidate(2, claim = $$props.claim);
    		if ("claimCategory" in $$props) $$invalidate(3, claimCategory = $$props.claimCategory);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("selectedValue" in $$props) $$invalidate(4, selectedValue = $$props.selectedValue);
    	};
    ...
    function create_if_block_1$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(48:8) {#if questions.length > 0}",
    		ctx
    	});
    ...
    // (49:12) {#each questions as qs}
    function create_each_block_1(ctx) {
    	let li;
    	let t_value = /*qs*/ ctx[7].text + "";
    	let t;
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(li, file$b, 49, 16, 1039);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*questions*/ 1 && t_value !== (t_value = /*qs*/ ctx[7].text + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(49:12) {#each questions as qs}",
    		ctx
    	});
    ...
    function create_if_block$5(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(56:8) {#if claims.length > 0}",
    		ctx
    	});
    ...
    // (57:12) {#each claims as cl}
    function create_each_block$3(ctx) {
    	let li;
    	let t_value = /*cl*/ ctx[4].text + "";
    	let t;
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(li, file$b, 57, 16, 1195);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*claims*/ 2 && t_value !== (t_value = /*cl*/ ctx[4].text + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(li);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(57:12) {#each claims as cl}",
    		ctx
    	});
    ...
    function create_fragment$d(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*questions*/ ctx[0].length > 0 && create_if_block_1$3(ctx);
    	let if_block1 = /*claims*/ ctx[1].length > 0 && create_if_block$5(ctx);
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			var button0_nodes = children(button0);
    			t6 = claim_text(button0_nodes, "Get Questions");
    			button0_nodes.forEach(detach_dev);
    			t7 = claim_space(main_nodes);
    			button1 = claim_element(main_nodes, "BUTTON", { class: true });
    			var button1_nodes = children(button1);
    			t8 = claim_text(button1_nodes, "Get Claims");
    			button1_nodes.forEach(detach_dev);
    		...
    		h: function hydrate() {
    			add_location(br0, file$b, 39, 4, 742);
    			add_location(br1, file$b, 40, 4, 753);
    			attr_dev(h3, "class", "svelte-qfz70i");
    			add_location(h3, file$b, 41, 4, 764);
    			add_location(br2, file$b, 42, 26, 809);
    			add_location(br3, file$b, 43, 4, 820);
    			attr_dev(button0, "class", "svelte-qfz70i");
    			add_location(button0, file$b, 44, 4, 831);
    			attr_dev(button1, "class", "svelte-qfz70i");
    			add_location(button1, file$b, 45, 4, 890);
    			add_location(div0, file$b, 46, 4, 946);
    			add_location(div1, file$b, 54, 4, 1108);
    			attr_dev(main, "class", "svelte-qfz70i");
    			add_location(main, file$b, 38, 0, 731);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, main, anchor);
    			append_dev(main, br0);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*getQuestions*/ ctx[2], false, false, false),
    					listen_dev(button1, "click", /*getQuestions*/ ctx[2], false, false, false)
    				];
    ...
    function instance$d($$self, $$props, $$invalidate) {
    	...
    	function getQuestions() {
    		doGet(questionUrl).then(qs => $$invalidate(0, questions = qs));
    	}
    	...
    	return [questions, claims, getQuestions];
    }

    class NewGame extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$d, create_fragment$d, safe_not_equal, { questions: 0, claims: 1 });
